...
const HeroSection = () => {
  return (
    <motion.section className="flex min-h-dvh w-full flex-col bg-juno-25 md:min-h-[800px]">
      ...
      <header className="w-full px-4 pb-6 pt-24 md:px-6 md:pb-9 md:pt-36">
        <div
          className="mx-auto flex flex-col items-center gap-2 text-center md:flex-row md:flex-wrap md:items-end md:justify-between md:gap-6 md:text-left"
      ...
      {/* Middle: Hero Video */}
      <div className="relative min-h-[200px] flex-1 overflow-hidden md:min-h-[560px]">
      ...
      <footer className="w-full bg-juno-25 px-4 pb-12 pt-8 md:px-6 md:pb-16 md:pt-12">
        <div
          className="mx-auto flex flex-col items-center gap-6 text-center md:flex-row md:items-center md:justify-between md:gap-8 md:text-left"
          style={{ maxWidth: CONTAINER_MAX_WIDTH }}
        >
