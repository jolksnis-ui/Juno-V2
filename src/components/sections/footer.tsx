...
export const Footer = () => {
  return (
    <footer className="relative flex min-h-screen w-full flex-col justify-between bg-[#18181B] px-10 pb-8 pt-[148px] text-white">
      {/* Background Texture */}
      ...
      <div className="relative z-10 flex flex-col gap-12">
        ...
        <div className="flex items-center justify-between">
          <motion.h2
            ...
            className="w-[440px] font-[family-name:var(--font-fraunces)] text-[60px] font-light leading-[68px] text-white"
          >
            Time is money.
            <br />
            Save both.
          ...
          <motion.p
            ...
            className="w-[320px] text-base leading-normal text-[#D1D1D6]"
          >
                ...
                <ul className="flex flex-col gap-4">
                  {links.map((link) => (
                    <li key={link.label}>
                      <Link
                        href={link.href}
                        className="text-base text-[#FCFCFC] transition-colors hover:text-white/70"
                      >
                        {link.label}
                      </Link>
                    </li>
      ...
      <div className="relative z-10 flex flex-col gap-8">
        ...
        >
          <span className="font-[family-name:var(--font-fraunces)] text-[32px] font-light text-white">
            juno
          </span>
        </motion.div>
        ...
        {/* Legal Text */}
        <div className="flex flex-col gap-6 font-[family-name:var(--font-geist-mono)] text-sm text-[#A0A0AB]">
